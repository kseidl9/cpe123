...
function draw(){
	...
	if (mouseX > 47 && mouseX < 85 && mouseY > 270 && mouseY<500 && clicked){
		if (manX < 180){
			...
			} else if (sceneScale < MAX_SCALE){
					translateX /= sceneScale;
					translateY /= sceneScale;
					translateX-= pipeDx * sceneScale / ((MAX_SCALE - INITIAL_SCALE) / SCALE_INCREMENT);
					translateY-= pipeDy * sceneScale / ((MAX_SCALE - INITIAL_SCALE) / SCALE_INCREMENT);
					sceneScale+=SCALE_INCREMENT;			
			} 	
		}
	}
}
